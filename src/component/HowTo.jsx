    ...
    <div>
      ...
      >
        <Container text style={{}}>
          ...
          <p style={{ fontSize: '1em' }}>More information about the City Council Meetings, and the Council itself, can be found at the City’s official Council Website, here: <a href="https://www.smgov.net/departments/council/">https://www.smgov.net/departments/council/</a></p>
        </Container>
      </Segment>
    </div>
  );
