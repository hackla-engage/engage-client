      ...
      <Container className="box" textAlign="center">
        ...
        <div className="email-box">
          ...
          <div className="what-text" style={{ marginTop: '15px'}}>
            <h4 className="what-heading heading">We would love your feedback</h4>
            <p>We would love to hear your opinion on the process of submitting a comment.<br />To complete the survey click <a href="https://docs.google.com/forms/d/e/1FAIpQLSc6eyRS-XWYIBrJKoxhupC_IA5iU9DqedBljfW2gfJw9ZcYag/viewform" target='_blank'>here</a>.</p>
          </div>
        </div>
        <div>
