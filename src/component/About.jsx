    ...
    <div className="ui middle aligned stackable grid container">
      <div className="row">
        <div className="ui text container">
          ...
          <p>
              Engage is a tool that lets you easily follow issues your city council is debating.
              More importantly, it provides a platform for expressing your views on these issues, in
              a way you know will be heard by your city.
          </p>
        </div>
      </div>
      <div className="row">
        <div className="ui text container">
          ...
          <p>
              ...
              solution that works for all local governments, but for now are starting with the city
              of Santa Monica.
          </p>
          <p>
