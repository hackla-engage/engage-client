...
class MailChimpForm extends Component {
    ...
    handleSubmit = (e) => {
        ...
        if (error) {
            this.setState({formError:true,serverRequestError:false,formSuccess:false})
        }
    ...
    render() {
        ...
        return (
            <div id={this.props.id}>
                <Form error={this.state.formError || this.state.serverRequestError} 
                        success={this.state.formSuccess} size='large' onSubmit={this.handleSubmit}>
                    <Form.Group>
